...
const ContactPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-green-300 via-green-200 to-green-100 p-4">
      <div className="bg-white p-6 rounded-2xl shadow-lg w-full max-w-lg md:max-w-2xl lg:max-w-2xl flex flex-col md:flex-row">
        <div className="flex-1 p-4 flex flex-col justify-center">
          <h2 className="text-4xl font-mono text-green-600 tracking-tight font-medium mb-4">Let's Connect</h2>

          {status && (
            <p className={`mb-4 text-sm font-medium ${status.type === "success" ? "text-green-600" : "text-red-500"}`}>
              {status.message}
            </p>
          )}
