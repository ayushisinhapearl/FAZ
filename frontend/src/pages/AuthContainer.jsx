...
//         {/* Welcome Text */}
//         <div className={`transition-all duration-1000 ${isSignIn ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"}`}>
//           <h2 className="text-4xl md:text-5xl text-customGreen font-bold">Welcome</h2>
//         </div>
//         {/* Join Us Text */}
//         <div className={`transition-all duration-1000 ${isSignIn ? "translate-x-full opacity-0" : "translate-x-0 opacity-100"}`}></div>
//       </div>
//     </div>
//   );
// };
